...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.Parameter(torch.Tensor(n_features * embeddings.shape[1], hidden_size))
        self.embed_to_hidden_bias = nn.Parameter(torch.Tensor(1, hidden_size))
